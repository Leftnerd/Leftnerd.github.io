...
[![GitHub stars](https://img.shields.io/github/stars/Leftnerd/Leftnerd.github.io.svg)](https://github.com/Leftnerd/Leftnerd.github.io/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/Leftnerd/Leftnerd.github.io.svg)](https://github.com/Leftnerd/Leftnerd.github.io/network)
[![GitHub issues](https://img.shields.io/github/issues/Leftnerd/Leftnerd.github.io.svg)](https://github.com/Leftnerd/Leftnerd.github.io/issues)
[![GitHub release](https://img.shields.io/github/release/Leftnerd/Leftnerd.github.io.svg)](https://github.com/Leftnerd/Leftnerd.github.io/releases)
[![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://raw.githubusercontent.com/Leftnerd/Leftnerd.github.io/master/LICENSE)
...
**Welcome to use this blog theme, but please keep the theme author info at footer.** Theme designed by [Leftnerd](https://github.com/Leftnerd).
...
url: "http://Leftnerd.github.io" # the base hostname & protocol for your site
```
...
```yml
# other links
twitter_username: Leftnerd126
facebook_username: Leftnerd.water
github_username:  Leftnerd
email: Leftnerd126@126.com
weibo_username: 3115521wh
zhihu_username: Leftnerd
linkedIn_username: Leftnerd
dribbble_username:
...
# comments
# two ways to comment, only choose one, and use your own short name
duoshuo_shortname: #Leftnerdblog
...
|:----------------------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------:|:---------------------------------------------------------------------------:|
| [![PayPal](https://www.paypalobjects.com/webstatic/paypalme/images/pp_logo_small.png)<br>Donate via PayPal ](https://www.paypal.me/Leftnerd) | ![wechat](http://ww2.sinaimg.cn/large/7011d6cfjw1f3bkdw3bslj206z06q3z6.jpg) | ![alipay](http://ww2.sinaimg.cn/large/7011d6cfjw1f3bk8ikzoij20740743z5.jpg) |

## Update Log

### 2017.2.28

- `[^]` fix smoothScroll bug in Tencent webview like wechat and qq.  [#22](https://github.com/Leftnerd/Leftnerd.github.io/issues/22), [#48](https://github.com/Leftnerd/Leftnerd.github.io/issues/48)
...
* `[^]` Fix bug in tags cloud when division by zero. [#26](https://github.com/Leftnerd/Leftnerd.github.io/issues/26), [#28](https://github.com/Leftnerd/Leftnerd.github.io/issues/28), [#30](https://github.com/Leftnerd/Leftnerd.github.io/issues/30)
...
About my old blog theme, I won't maintain any more. And I put the code at  [Leftnerd/old-blog](https://github.com/Leftnerd/old-blog).

## License

[MIT License](https://github.com/Leftnerd/Leftnerd.github.io/blob/master/LICENSE.md)
